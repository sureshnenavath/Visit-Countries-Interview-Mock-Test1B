...
const App = () => {
  ...
  const filterVisitedListFun = () => {
    const updatedVisited = countriesList.filter(
      eachItem => eachItem.isVisited === true,
    );
    setVisitedList(updatedVisited);
  };
  ...
  useEffect(() => {
    filterVisitedListFun();
  }, [countriesList, filterVisitedListFun]); // Added filterVisitedListFun as dependency
            ...
            <li key={eachItem.id}>
              <div className="each-item-details">
                ...
                <button
                  ...
                  onClick={() => handleToggleVisit(eachItem.id)}
                >
              ...
              {visitedList.map(eachItem => (
                <li key={eachItem.id}>
                  <div className="visited-countries-container">
                    ...
                    />
                    <div className="visited-list-name-butt">
                      <p>{eachItem.name}</p>
                      <button
                        type="button" // Added explicit type attribute
                        onClick={() => handleToggleVisit(eachItem.id)}
